...
class OpenTrade(models.Model):
    ...
    quantity = models.DecimalField(max_digits=20, decimal_places=4, null=False, blank=False)
    cumulative_quote_qty = models.DecimalField(max_digits=20, decimal_places=4, null=False, blank=False)
...
class TradeHistory(models.Model):
    ...
    take_profit = models.DecimalField(max_digits=20, decimal_places=4, null=True, blank=True)
    stop_loss = models.DecimalField(max_digits=20, decimal_places=4, null=True, blank=True)
    net_pl = models.DecimalField(max_digits=20, decimal_places=4, null=False, blank=False)
