# Generated by Django 4.2.10 on 2024-03-26 11:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cumulative_quote_qty', models.DecimalField(decimal_places=4, max_digits=20)),
                ...
                ('take_profit', models.DecimalField(blank=True, decimal_places=4, max_digits=20, null=True)),
                ('stop_loss', models.DecimalField(blank=True, decimal_places=4, max_digits=20, null=True)),
                ('net_pl', models.DecimalField(decimal_places=4, max_digits=20)),
